            ...
            <CardBody className="gap-8">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
                        <div>
                            ...
                            <Skeleton isLoaded={!!dataTransaction?.orderId} className="h-4 rounded-md">
                        ...
                        <div>
                            ...
                            <Skeleton isLoaded={!!dataTransaction?.total} className="h-4 rounded-md">
                        ...
                        <div>
                            ...
                            <Skeleton isLoaded={!!dataTransaction?.total} className="h-4 rounded-md">
                                <Chip 
                                    ...
                                    color={dataTransaction?.status === "completed" ? "success" : "warning"}
                                    variant="flat"
                                    size="sm"
                ...
                {dataTransaction?.status === "pending" && (
                    <Button 
                        color="danger"
                        className="w-fit"
                        onPress={() => (window as any).snap.pay(dataTransaction?.payment?.token)}
                        >
                            Pay Now
                        </Button>
                    )}
